...
<h3 class="text-center">Highlight Operated Timestamper <?php echo $version; ?></h3>
<p>Highlight Operated Timestamper was made to help me with collecton and sorting of clips</p>
