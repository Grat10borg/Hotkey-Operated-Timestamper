<html>
<head>
    <title>Twitch | Token Checker</title>
...
<body>
    ...
    <ul>
        ...
        <li><a href="https://dev.twitch.tv/docs/authentication#revoking-access-tokens">Revoking a token</a></li>
    </ul>
    ...
    <script type="text/javascript">
        ...
        function fetchUser(access_token) {
            ...
            fetch(
                'https://api.twitch.tv/helix/users?login=hayblene',
                {
                    "headers": {
                        "Client-ID": client_id,
                        "Authorization": "Bearer " + access_token
        ...
        function revokeToken() {
            ...
            .then(resp => {
                if (resp.status != 200) {
                    document.getElementById('revoke_output').textContent = 'Token Revoke Error: ' + resp.status;
                } else {
